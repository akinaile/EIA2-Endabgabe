namespace garden {
    ...
    export class Field {
        ...
        market: Market; //das es an die klasse market weitergegeben werden kann
        plants: object;
        plant: Plant | null;
        ...
        grow(_tick: number): void { // 1 tick = 10 sek
        ...
        cropPlant(): void {
            this.market.sellProduct(this.plant.price); //Pflanze wird verkauft und der aktuelle Verkaufspreis wird auf totalCapital gerechnet
