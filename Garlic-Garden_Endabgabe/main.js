...
(function (farm) {
    ...
    function hideScreen1() {
        ...
        cropProducts.push(new farm.Product("Potato", "cropProduct", 1 * 3, priceVariation * 2 + 3));
        ...
        cropProducts.push(new farm.Product("Carrot", "cropProduct", 1 * 3, priceVariation * 2 + 5));
        ...
        cropProducts.push(new farm.Product("Eggplant", "cropProduct", 1 * 3, priceVariation * 2 + 7));
        ...
        cropProducts.push(new farm.Product("Garlic", "cropProduct", 1 * 3, priceVariation * 2 + 8));
